...
- program_a_loop.cu (версия программы A для запуска в цикле и обработки всех изображений)
- program_b_loop.cu (версяи программы B для запуска в цикле и обработки всех изображений)
...
Для компиляции программы в консоли можно использовать команду следующего вида:

nvcc -o <имя выходного файла>.exe \\ \
-allow-unsupported-complier \\ \
<имя программы>.cu \\ \
-I"<путь до OpenCV>\\opencv\\build\\include" \\ \
-L"<путь до OpenCV>\\opencv\\build\\x64\\vc16\\lib" \\ \
-l"opencv_world4120"

<путь до OpenCV> зависит от того, куда OpenCV был установлен.\
-allow-unsupported-compliler может не понадобиться, если версия VisualStudio совместима с NVIDIA GPU Computing Toolkit.
